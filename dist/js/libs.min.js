...
+function($) {
    ...
    var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(obj) {
        ...
        var NAME = "alert", VERSION = "4.0.0-alpha.6", DATA_KEY = "bs.alert", EVENT_KEY = "." + DATA_KEY, DATA_API_KEY = ".data-api", JQUERY_NO_CONFLICT = $.fn[NAME], TRANSITION_DURATION = 150, Selector = {
            ...
            return Alert.prototype.close = function(element) {
                ...
                var _this2 = this;
                return $(element).removeClass(ClassName.SHOW), Util.supportsTransitionEnd() && $(element).hasClass(ClassName.FADE) ? void $(element).one(Util.TRANSITION_END, function(event) {
                    return _this2._destroyElement(element, event);
                }).emulateTransitionEnd(TRANSITION_DURATION) : void this._destroyElement(element);
        ...
        return $(document).on(Event.CLICK_DATA_API, Selector.DISMISS, Alert._handleDismiss(new Alert())), 
        ...
        var NAME = "button", VERSION = "4.0.0-alpha.6", DATA_KEY = "bs.button", EVENT_KEY = "." + DATA_KEY, DATA_API_KEY = ".data-api", JQUERY_NO_CONFLICT = $.fn[NAME], ClassName = {
            ACTIVE: "active",
            BUTTON: "btn",
            FOCUS: "focus"
        }, Selector = {
        ...
        var NAME = "carousel", VERSION = "4.0.0-alpha.6", DATA_KEY = "bs.carousel", EVENT_KEY = "." + DATA_KEY, DATA_API_KEY = ".data-api", JQUERY_NO_CONFLICT = $.fn[NAME], TRANSITION_DURATION = 600, ARROW_LEFT_KEYCODE = 37, ARROW_RIGHT_KEYCODE = 39, Default = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
            ...
            return Carousel.prototype.next = function() {
                ...
                var isNextDirection = direction === Direction.NEXT, isPrevDirection = direction === Direction.PREVIOUS, activeIndex = this._getItemIndex(activeElement), lastItemIndex = this._items.length - 1, isGoingToWrap = isPrevDirection && 0 === activeIndex || isNextDirection && activeIndex === lastItemIndex;
                ...
                if (!slideEvent.isDefaultPrevented() && activeElement && nextElement) {
                    ...
                    }).emulateTransitionEnd(TRANSITION_DURATION)) : ($(activeElement).removeClass(ClassName.ACTIVE), 
        ...
        return $(document).on(Event.CLICK_DATA_API, Selector.DATA_SLIDE, Carousel._dataApiClickHandler), 
        ...
        var NAME = "collapse", VERSION = "4.0.0-alpha.6", DATA_KEY = "bs.collapse", EVENT_KEY = "." + DATA_KEY, DATA_API_KEY = ".data-api", JQUERY_NO_CONFLICT = $.fn[NAME], TRANSITION_DURATION = 600, Default = {
            toggle: !0,
            parent: ""
        }, DefaultType = {
            toggle: "boolean",
            ...
            return Collapse.prototype.toggle = function() {
                ...
                if (!$(this._element).hasClass(ClassName.SHOW)) {
                    ...
                    actives.length || (actives = null)), !(actives && (activesData = $(actives).data(DATA_KEY), 
                ...
                if ($(this._element).hasClass(ClassName.SHOW)) {
                    ...
                    if ($(this._element).trigger(startEvent), !startEvent.isDefaultPrevented()) {
                        ...
                        return this._element.style[dimension] = "", Util.supportsTransitionEnd() ? void $(this._element).one(Util.TRANSITION_END, complete).emulateTransitionEnd(TRANSITION_DURATION) : void complete();
                    }
                }
                ...
                return this.each(function() {
                    var $this = $(this), data = $this.data(DATA_KEY), _config = $.extend({}, Default, $this.data(), "object" === ("undefined" == typeof config ? "undefined" : _typeof(config)) && config);
        ...
        var NAME = "dropdown", VERSION = "4.0.0-alpha.6", DATA_KEY = "bs.dropdown", EVENT_KEY = "." + DATA_KEY, DATA_API_KEY = ".data-api", JQUERY_NO_CONFLICT = $.fn[NAME], ESCAPE_KEYCODE = 27, ARROW_UP_KEYCODE = 38, ARROW_DOWN_KEYCODE = 40, RIGHT_MOUSE_BUTTON_WHICH = 3, Event = {
            HIDE: "hide" + EVENT_KEY,
            HIDDEN: "hidden" + EVENT_KEY,
            SHOW: "show" + EVENT_KEY,
            SHOWN: "shown" + EVENT_KEY,
            ...
            return Dropdown.prototype.toggle = function() {
                ...
                return this.each(function() {
                    var data = $(this).data(DATA_KEY);
                    if (data || (data = new Dropdown(this), $(this).data(DATA_KEY, data)), "string" == typeof config) {
                        if (void 0 === data[config]) throw new Error('No method named "' + config + '"');
                ...
                event.stopPropagation(), !this.disabled && !$(this).hasClass(ClassName.DISABLED))) {
                    ...
                    if (items.length) {
                        ...
                        event.which === ARROW_UP_KEYCODE && index > 0 && index--, event.which === ARROW_DOWN_KEYCODE && index < items.length - 1 && index++, 
        ...
        return $(document).on(Event.KEYDOWN_DATA_API, Selector.DATA_TOGGLE, Dropdown._dataApiKeydownHandler).on(Event.KEYDOWN_DATA_API, Selector.ROLE_MENU, Dropdown._dataApiKeydownHandler).on(Event.KEYDOWN_DATA_API, Selector.ROLE_LISTBOX, Dropdown._dataApiKeydownHandler).on(Event.CLICK_DATA_API + " " + Event.FOCUSIN_DATA_API, Dropdown._clearMenus).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, Dropdown.prototype.toggle).on(Event.CLICK_DATA_API, Selector.FORM_CHILD, function(e) {
            e.stopPropagation();
        ...
        var NAME = "modal", VERSION = "4.0.0-alpha.6", DATA_KEY = "bs.modal", EVENT_KEY = "." + DATA_KEY, DATA_API_KEY = ".data-api", JQUERY_NO_CONFLICT = $.fn[NAME], TRANSITION_DURATION = 300, BACKDROP_TRANSITION_DURATION = 150, ESCAPE_KEYCODE = 27, Default = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
            ...
            return Modal.prototype.toggle = function(relatedTarget) {
                ...
                $.removeData(this._element, DATA_KEY), $(window, document, this._element, this._backdrop).off(EVENT_KEY), 
                ...
                this._isShown && this._config.keyboard ? $(this._element).on(Event.KEYDOWN_DISMISS, function(event) {
                    event.which === ESCAPE_KEYCODE && _this13.hide();
                ...
                if (this._isShown && this._config.backdrop) {
                    ...
                    $(this._element).on(Event.CLICK_DISMISS, function(event) {
                        return _this16._ignoreBackdropClick ? void (_this16._ignoreBackdropClick = !1) : void (event.target === event.currentTarget && ("static" === _this16._config.backdrop ? _this16._element.focus() : _this16.hide()));
                ...
                return this.each(function() {
                    var data = $(this).data(DATA_KEY), _config = $.extend({}, Modal.Default, $(this).data(), "object" === ("undefined" == typeof config ? "undefined" : _typeof(config)) && config);
        ...
        var NAME = "scrollspy", VERSION = "4.0.0-alpha.6", DATA_KEY = "bs.scrollspy", EVENT_KEY = "." + DATA_KEY, DATA_API_KEY = ".data-api", JQUERY_NO_CONFLICT = $.fn[NAME], Default = {
            offset: 10,
            method: "auto",
            target: ""
        }, DefaultType = {
            ...
            return ScrollSpy.prototype.refresh = function() {
                ...
                $.removeData(this._element, DATA_KEY), $(this._scrollElement).off(EVENT_KEY), this._element = null, 
                ...
                return this.each(function() {
                    var data = $(this).data(DATA_KEY), _config = "object" === ("undefined" == typeof config ? "undefined" : _typeof(config)) && config;
                    if (data || (data = new ScrollSpy(this, _config), $(this).data(DATA_KEY, data)), 
        ...
        var NAME = "tab", VERSION = "4.0.0-alpha.6", DATA_KEY = "bs.tab", EVENT_KEY = "." + DATA_KEY, DATA_API_KEY = ".data-api", JQUERY_NO_CONFLICT = $.fn[NAME], TRANSITION_DURATION = 150, Event = {
            HIDE: "hide" + EVENT_KEY,
            HIDDEN: "hidden" + EVENT_KEY,
            SHOW: "show" + EVENT_KEY,
            SHOWN: "shown" + EVENT_KEY,
            ...
            return Tab.prototype.show = function() {
                ...
                active && isTransitioning ? $(active).one(Util.TRANSITION_END, complete).emulateTransitionEnd(TRANSITION_DURATION) : complete(), 
        ...
        var NAME = "tooltip", VERSION = "4.0.0-alpha.6", DATA_KEY = "bs.tooltip", EVENT_KEY = "." + DATA_KEY, JQUERY_NO_CONFLICT = $.fn[NAME], TRANSITION_DURATION = 150, CLASS_PREFIX = "bs-tether", Default = {
            animation: !0,
            ...
            return Tooltip.prototype.enable = function() {
                ...
                $(tip).one(Util.TRANSITION_END, complete).emulateTransitionEnd(TRANSITION_DURATION)) : complete(), 
                this._hoverState = "");
                ...
                var _this24 = this, triggers = this.config.trigger.split(" ");
                ...
                !context._isWithActiveTrigger()) return clearTimeout(context._timeout), context._hoverState = HoverState.OUT, 
                ...
                return this.each(function() {
                    ...
                    $(this).data(DATA_KEY, data)), "string" == typeof config)) {
                        if (void 0 === data[config]) throw new Error('No method named "' + config + '"');
                        data[config]();
                    }
                });
    ...
    (function($) {
        var NAME = "popover", VERSION = "4.0.0-alpha.6", DATA_KEY = "bs.popover", EVENT_KEY = "." + DATA_KEY, JQUERY_NO_CONFLICT = $.fn[NAME], Default = $.extend({}, Tooltip.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            ...
            return _inherits(Popover, _Tooltip), Popover.prototype.isWithContent = function() {
                ...
                return this.each(function() {
                    var data = $(this).data(DATA_KEY), _config = "object" === ("undefined" == typeof config ? "undefined" : _typeof(config)) ? config : null;
        ...
        return $.fn[NAME] = Popover._jQueryInterface, $.fn[NAME].Constructor = Popover, 
        $.fn[NAME].noConflict = function() {
...
var ResponsiveBootstrapToolkit = function($) {
    var internal = {
        ...
        splitExpression: function(str) {
            var operator = str.charAt(0), orEqual = "=" == str.charAt(1), index = 1 + (orEqual ? 1 : 0), breakpointName = str.slice(index);
            return {
                operator: operator,
                orEqual: orEqual,
...
function(factory) {
        ...
        this.each(function() {
            ...
            if (null !== target) {
                ...
                $.each(settings.axis.split(""), function(i, axis) {
                    var Pos = "x" === axis ? "Left" : "Top", pos = Pos.toLowerCase(), key = "scroll" + Pos, prev = $elem[key](), max = $scrollTo.max(elem, axis);
                    if (toff) attr[key] = toff[pos] + (win ? 0 : prev - $elem.offset()[pos]), settings.margin && (attr[key] -= parseInt(targ.css("margin" + Pos), 10) || 0, 
                    attr[key] -= parseInt(targ.css("border" + Pos + "Width"), 10) || 0), attr[key] += offset[pos] || 0, 
                    settings.over[pos] && (attr[key] += targ["x" === axis ? "width" : "height"]() * settings.over[pos]); else {
                        var val = targ[pos];
    ...
    "function" == typeof define && define.amd ? define([ "jquery" ], plugin) : plugin(jQuery);
}(function($) {
    function scroll(e, link, settings) {
        ...
        if (elem) {
            ...
            if (!(settings.lock && $target.is(":animated") || settings.onBefore && settings.onBefore(e, elem, $target) === !1)) {
                if (settings.stop && $target.stop(!0), settings.hash) {
                    var attr = elem.id === id ? "id" : "name", $a = $("<a> </a>").attr(attr, id).css({
                        position: "absolute",
                        top: $(window).scrollTop(),
                        left: $(window).scrollLeft()
                    });
                    elem[attr] = "", $("body").prepend($a), location.hash = link.hash, $a.remove(), 
                    elem[attr] = id;
                }
    ...
    var URI = location.href.replace(/#.*/, ""), $localScroll = $.localScroll = function(settings) {
    ...
    return $localScroll.defaults = {
        ...
        return settings = $.extend({}, $localScroll.defaults, settings), settings.hash && location.hash && (settings.target && window.scrollTo(0, 0), 
        scroll(0, location, settings)), settings.lazy ? this.on(settings.event, "a,area", function(e) {
            filter.call(this) && scroll(e, this, settings);
        }) : this.find("a,area").filter(filter).bind(settings.event, function(e) {
            scroll(e, this, settings);
        }).end().end();
    }, $localScroll.hash = function() {}, $localScroll;
}), function() {
    var $, win;
    $ = this.jQuery || window.jQuery, win = $(window), $.fn.stick_in_parent = function(opts) {
        var doc, elm, enable_bottoming, inner_scrolling, manual_spacer, offset_top, outer_width, parent_selector, recalc_every, sticky_class, _fn, _i, _len;
        for (null == opts && (opts = {}), sticky_class = opts.sticky_class, inner_scrolling = opts.inner_scrolling, 
        recalc_every = opts.recalc_every, parent_selector = opts.parent, offset_top = opts.offset_top, 
        manual_spacer = opts.spacer, enable_bottoming = opts.bottoming, null == offset_top && (offset_top = 0), 
        null == parent_selector && (parent_selector = void 0), null == inner_scrolling && (inner_scrolling = !0), 
        null == sticky_class && (sticky_class = "is_stuck"), doc = $(document), null == enable_bottoming && (enable_bottoming = !0), 
        outer_width = function(el) {
            var computed, w, _el;
            return window.getComputedStyle ? (_el = el[0], computed = window.getComputedStyle(el[0]), 
            w = parseFloat(computed.getPropertyValue("width")) + parseFloat(computed.getPropertyValue("margin-left")) + parseFloat(computed.getPropertyValue("margin-right")), 
            "border-box" !== computed.getPropertyValue("box-sizing") && (w += parseFloat(computed.getPropertyValue("border-left-width")) + parseFloat(computed.getPropertyValue("border-right-width")) + parseFloat(computed.getPropertyValue("padding-left")) + parseFloat(computed.getPropertyValue("padding-right"))), 
            w) : el.outerWidth(!0);
        }, _fn = function(elm, padding_bottom, parent_top, parent_height, top, height, el_float, detached) {
            var bottomed, detach, fixed, last_pos, last_scroll_height, offset, parent, recalc, recalc_and_tick, recalc_counter, spacer, tick;
            if (!elm.data("sticky_kit")) {
                if (elm.data("sticky_kit", !0), last_scroll_height = doc.height(), parent = elm.parent(), 
                null != parent_selector && (parent = parent.closest(parent_selector)), !parent.length) throw "failed to find stick parent";
                if (fixed = !1, bottomed = !1, spacer = null != manual_spacer ? manual_spacer && elm.closest(manual_spacer) : $("<div />"), 
                spacer && spacer.css("position", elm.css("position")), recalc = function() {
                    var border_top, padding_top, restore;
                    if (!detached) return last_scroll_height = doc.height(), border_top = parseInt(parent.css("border-top-width"), 10), 
                    padding_top = parseInt(parent.css("padding-top"), 10), padding_bottom = parseInt(parent.css("padding-bottom"), 10), 
                    parent_top = parent.offset().top + border_top + padding_top, parent_height = parent.height(), 
                    fixed && (fixed = !1, bottomed = !1, null == manual_spacer && (elm.insertAfter(spacer), 
                    spacer.detach()), elm.css({
                        position: "",
                        top: "",
                        width: "",
                        bottom: ""
                    }).removeClass(sticky_class), restore = !0), top = elm.offset().top - (parseInt(elm.css("margin-top"), 10) || 0) - offset_top, 
                    height = elm.outerHeight(!0), el_float = elm.css("float"), spacer && spacer.css({
                ...
                }, recalc(), height !== parent_height) return last_pos = void 0, offset = offset_top, 
                recalc_counter = recalc_every, tick = function() {
                    var css, delta, recalced, scroll, will_bottom, win_height;
                    if (!detached) return recalced = !1, null != recalc_counter && (recalc_counter -= 1, 
                    recalc_counter <= 0 && (recalc_counter = recalc_every, recalc(), recalced = !0)), 
                    recalced || doc.height() === last_scroll_height || (recalc(), recalced = !0), scroll = win.scrollTop(), 
                    null != last_pos && (delta = scroll - last_pos), last_pos = scroll, fixed ? (enable_bottoming && (will_bottom = scroll + height + offset > parent_height + parent_top, 
                    bottomed && !will_bottom && (bottomed = !1, elm.css({
                        position: "fixed",
                        bottom: "",
                        top: offset
                    }).trigger("sticky_kit:unbottom"))), scroll < top && (fixed = !1, offset = offset_top, 
                    null == manual_spacer && ("left" !== el_float && "right" !== el_float || elm.insertAfter(spacer), 
                    spacer.detach()), css = {
                        position: "",
                        width: "",
                        top: ""
                    }, elm.css(css).removeClass(sticky_class).trigger("sticky_kit:unstick")), inner_scrolling && (win_height = win.height(), 
                    height + offset_top > win_height && (bottomed || (offset -= delta, offset = Math.max(win_height - height, offset), 
                    offset = Math.min(offset_top, offset), fixed && elm.css({
                        top: offset + "px"
                    }))))) : scroll > top && (fixed = !0, css = {
                        position: "fixed",
                        top: offset
                    }, css.width = "border-box" === elm.css("box-sizing") ? elm.outerWidth() + "px" : elm.width() + "px", 
                    elm.css(css).addClass(sticky_class), null == manual_spacer && (elm.after(spacer), 
                    "left" !== el_float && "right" !== el_float || spacer.append(elm)), elm.trigger("sticky_kit:stick")), 
                    fixed && enable_bottoming && (null == will_bottom && (will_bottom = scroll + height + offset > parent_height + parent_top), 
                    !bottomed && will_bottom) ? (bottomed = !0, "static" === parent.css("position") && parent.css({
                        position: "relative"
                    }), elm.css({
                        position: "absolute",
                    ...
                    if (detached = !0, win.off("touchmove", tick), win.off("scroll", tick), win.off("resize", recalc_and_tick), 
                    $(document.body).off("sticky_kit:recalc", recalc_and_tick), elm.off("sticky_kit:detach", detach), 
                    elm.removeData("sticky_kit"), elm.css({
                        position: "",
                        bottom: "",
                        top: "",
                        width: ""
                    }), parent.position("position", ""), fixed) return null == manual_spacer && ("left" !== el_float && "right" !== el_float || elm.insertAfter(spacer), 
                    spacer.remove()), elm.removeClass(sticky_class);
                }, win.on("touchmove", tick), win.on("scroll", tick), win.on("resize", recalc_and_tick), 
                $(document.body).on("sticky_kit:recalc", recalc_and_tick), elm.on("sticky_kit:detach", detach), 
                setTimeout(tick, 0);
            }
    ...
    function getScrollParents(el) {
        ...
        for (var parent = el; (parent = parent.parentNode) && parent && 1 === parent.nodeType; ) {
            ...
            if ("undefined" == typeof style || null === style) return parents.push(parent), 
            parents;
    ...
    function getBounds(el) {
        ...
        return box.top -= origin.top, box.left -= origin.left, "undefined" == typeof box.width && (box.width = document.body.scrollWidth - box.left - box.right), 
        "undefined" == typeof box.height && (box.height = document.body.scrollHeight - box.top - box.bottom), 
    ...
    function removeClass(el, name) {
        if ("undefined" != typeof el.classList) name.split(" ").forEach(function(cls) {
            cls.trim() && el.classList.remove(cls);
        }); else {
            var regex = new RegExp("(^| )" + name.split(" ").join("|") + "( |$)", "gi"), className = getClassName(el).replace(regex, " ");
    ...
    function hasClass(el, name) {
        if ("undefined" != typeof el.classList) return el.classList.contains(name);
    ...
    function getBoundingRect(tether, to) {
        ...
        to === document && (to = to.documentElement), "undefined" != typeof to.nodeType && !function() {
    ...
    "undefined" == typeof TetherBase && (TetherBase = {
        modules: []
    });
    var zeroElement = null, uniqueId = function() {
        ...
        return "undefined" == typeof zeroPosCache[id] && (zeroPosCache[id] = getActualBoundingClientRect(node), 
        defer(function() {
        ...
        return _createClass(Evented, [ {
            ...
            value: function(event, handler, ctx) {
                ...
                "undefined" == typeof this.bindings && (this.bindings = {}), "undefined" == typeof this.bindings[event] && (this.bindings[event] = []), 
            ...
            value: function(event, handler) {
                if ("undefined" != typeof this.bindings && "undefined" != typeof this.bindings[event]) if ("undefined" == typeof handler) delete this.bindings[event]; else for (var i = 0; i < this.bindings[event].length; ) this.bindings[event][i].handler === handler ? this.bindings[event].splice(i, 1) : ++i;
            }
        }, {
            key: "trigger",
            value: function(event) {
                if ("undefined" != typeof this.bindings && this.bindings[event]) {
                    ...
                    for (;i < this.bindings[event].length; ) {
                        ...
                        "undefined" == typeof context && (context = this), handler.apply(context, args), 
                        once ? this.bindings[event].splice(i, 1) : ++i;
                    }
                }
            }
        } ]), Evented;
    ...
    if ("undefined" == typeof TetherBase) throw new Error("You must include the utils.js file before tether.js");
    ...
    !function() {
        var lastCall = null, lastDuration = null, pendingTimeout = null, tick = function tick() {
            return "undefined" != typeof lastDuration && lastDuration > 16 ? (lastDuration = Math.min(lastDuration - 16, 250), 
            void (pendingTimeout = setTimeout(tick, 250))) : void ("undefined" != typeof lastCall && now() - lastCall < 10 || (null != pendingTimeout && (clearTimeout(pendingTimeout), 
            pendingTimeout = null), lastCall = now(), position(), lastDuration = now() - lastCall));
        };
        "undefined" != typeof window && "undefined" != typeof window.addEventListener && [ "resize", "scroll", "touchmove" ].forEach(function(event) {
    ...
    var MIRROR_LR = {
        ...
        var left = attachment.left, top = attachment.top;
        return "undefined" != typeof OFFSET_MAP[attachment.left] && (left = OFFSET_MAP[attachment.left]), 
        "undefined" != typeof OFFSET_MAP[attachment.top] && (top = OFFSET_MAP[attachment.top]), 
        {
            left: left,
            top: top
        };
    }, parseOffset = function(value) {
        var _value$split = value.split(" "), _value$split2 = _slicedToArray(_value$split, 2), top = _value$split2[0], left = _value$split2[1];
        return {
            top: top,
            left: left
        };
        ...
        function TetherClass(options) {
            ...
            this.setOptions(options, !1), TetherBase.modules.forEach(function(module) {
                "undefined" != typeof module.initialize && module.initialize.call(_this);
            }), this.position();
        }
        return _inherits(TetherClass, _Evented), _createClass(TetherClass, [ {
            ...
            value: function() {
                ...
                return "undefined" != typeof classes && classes[key] ? this.options.classes[key] : this.options.classPrefix ? this.options.classPrefix + "-" + key : key;
            }
        }, {
            key: "setOptions",
            value: function(options) {
                ...
                this.targetModifier = "scroll-handle"), [ "element", "target" ].forEach(function(key) {
                    if ("undefined" == typeof _this2[key]) throw new Error("Tether Error: Both element and target must be defined");
                    "undefined" != typeof _this2[key].jquery ? _this2[key] = _this2[key][0] : "string" == typeof _this2[key] && (_this2[key] = document.querySelector(_this2[key]));
                ...
                "undefined" != typeof this.scrollParents && this.disable(), "scroll-handle" === this.targetModifier ? this.scrollParents = [ this.target ] : this.scrollParents = getScrollParents(this.target), 
                this.options.enabled !== !1 && this.enable(pos);
            }
        }, {
            key: "getTargetBounds",
            value: function() {
                if ("undefined" == typeof this.targetModifier) return getBounds(this.target);
            ...
            value: function(k, getter) {
                return "undefined" == typeof this._cache && (this._cache = {}), "undefined" == typeof this._cache[k] && (this._cache[k] = getter.call(this)), 
                this._cache[k];
            }
        }, {
            key: "enable",
            ...
            value: function() {
                ...
                this.enabled = !1, "undefined" != typeof this.scrollParents && this.scrollParents.forEach(function(parent) {
            ...
            value: function(elementAttach, targetAttach) {
                ...
                sides.forEach(function(side) {
                    ...
                    "undefined" != typeof _this6._addAttachClasses && (updateClasses(_this6.element, _this6._addAttachClasses, all), 
            ...
            value: function() {
                ...
                if (this.enabled) {
                    ...
                    if (0 === width && 0 === height && "undefined" != typeof this.lastSize) {
                    ...
                    for (var left = targetPos.left + targetOffset.left - offset.left, top = targetPos.top + targetOffset.top - offset.top, i = 0; i < TetherBase.modules.length; ++i) {
                        ...
                        if (ret === !1) return !1;
                        "undefined" != typeof ret && "object" == typeof ret && (top = ret.top, left = ret.left);
                    }
                    var next = {
                        page: {
                            top: top,
                    ...
                    next.page.right = doc.body.scrollWidth - left - width), "undefined" != typeof this.options.optimizations && this.options.optimizations.moveElement !== !1 && "undefined" == typeof this.targetModifier && !function() {
            ...
            value: function(pos) {
                ...
                if ("undefined" != typeof this.element.parentNode) {
                    ...
                    for (var type in pos) {
                        ...
                        for (var key in pos[type]) {
                            for (var found = !1, i = 0; i < this.history.length; ++i) {
                                ...
                                if ("undefined" != typeof point[type] && !within(point[type][key], pos[type][key])) {
                                    found = !0;
                                    break;
                                }
                            }
                    ...
                    var css = {
                        ...
                        var hasOptimizations = "undefined" != typeof _this8.options.optimizations, gpu = hasOptimizations ? _this8.options.optimizations.gpu : null;
                        if (gpu !== !1) {
                            var yPos = void 0, xPos = void 0;
                            if (_same.top ? (css.top = 0, yPos = _pos.top) : (css.bottom = 0, yPos = -_pos.bottom), 
                            _same.left ? (css.left = 0, xPos = _pos.left) : (css.right = 0, xPos = -_pos.right), 
                            window.matchMedia) {
                                var retina = window.matchMedia("only screen and (min-resolution: 1.3dppx)").matches || window.matchMedia("only screen and (-webkit-min-device-pixel-ratio: 1.3)").matches;
                                retina || (xPos = Math.round(xPos), yPos = Math.round(yPos));
                            }
                            css[transformKey] = "translateX(" + xPos + "px) translateY(" + yPos + "px)", "msTransform" !== transformKey && (css[transformKey] += " translateZ(0)");
                    ...
                    transcribe(same.viewport, pos.viewport)) : "undefined" != typeof same.offset && same.offset.top && same.offset.left ? !function() {
                    ...
                    for (var key in css) {
                        var val = css[key], elVal = this.element.style[key];
                        elVal !== val && (write = !0, writeCSS[key] = val);
                    }
    ...
    TetherBase.modules.push({
        position: function(_ref) {
            ...
            return this.options.constraints.forEach(function(constraint) {
                ...
                "undefined" == typeof attachment && (attachment = "");
                ...
                pinned.push("right")) : oob.push("right")), pinned.length && !function() {
                    ...
                    pinnedClass = "undefined" != typeof _this.options.pinnedClass ? _this.options.pinnedClass : _this.getClass("pinned"), 
                    addClasses.push(pinnedClass), pinned.forEach(function(side) {
                        addClasses.push(pinnedClass + "-" + side);
                    });
                }(), oob.length && !function() {
                    var oobClass = void 0;
                    oobClass = "undefined" != typeof _this.options.outOfBoundsClass ? _this.options.outOfBoundsClass : _this.getClass("out-of-bounds"), 
    ...
    function _executeLazy(instance, config, items, events, namespace) {
        function _initialize() {
            _isRetinaDisplay = window.devicePixelRatio > 1, _prepareItems(items), config.delay >= 0 && setTimeout(function() {
                _lazyLoadItems(!0);
                ...
                _prepareItems(additionalItems), items.push.apply(items, additionalItems);
            }, events.g = function() {
        ...
        function _prepareItems(items) {
            ...
            for (var i = 0, l = items.length; i < l; i++) {
                ...
                tag == _img && elementImageBase && element.attr(srcsetAttribute) && element.attr(srcsetAttribute, _getCorrectedSrcSet(element.attr(srcsetAttribute), elementImageBase)), 
                forcedTags[tag] === undefined || element.attr(loaderAttribute) || element.attr(loaderAttribute, forcedTags[tag]), 
                tag == _img && defaultImage && !element.attr(_src) ? element.attr(_src, defaultImage) : tag == _img || !placeholder || element.css(_backgroundImage) && "none" != element.css(_backgroundImage) || element.css(_backgroundImage, "url('" + placeholder + "')");
            }
        }
        function _lazyLoadItems(allItems, forced) {
            if (!items.length) return void (config.autoDestroy && instance.destroy());
            for (var elements = forced || items, loadTriggered = !1, imageBase = config.imageBase || "", srcsetAttribute = config.srcsetAttribute, handledName = config.handledName, i = 0; i < elements.length; i++) if (allItems || forced || _isInLoadableArea(elements[i])) {
                ...
                element.data(handledName) || config.visibleOnly && !element.is(":visible") || !((attribute || element.attr(srcsetAttribute)) && (tag == _img && (elementImageBase + attribute != element.attr(_src) || element.attr(srcsetAttribute) != element.attr(_srcset)) || tag != _img && elementImageBase + attribute != element.css(_backgroundImage)) || customLoader) || (loadTriggered = !0, 
                element.data(handledName, !0), _handleItem(element, tag, elementImageBase, customLoader));
            }
        ...
        function _handleItem(element, tag, imageBase, customLoader) {
            ...
            var errorCallback = function() {
                _triggerCallback("onError", element), _reduceAwaiting(), errorCallback = $.noop;
            };
            ...
            if (customLoader) {
                var loadCallback = function() {
                    removeAttribute && element.removeAttr(config.loaderAttribute), element.data(loadedName, !0), 
                    _triggerCallback(_afterLoad, element), setTimeout(_reduceAwaiting, 1), loadCallback = $.noop;
                };
                element.off(_error).one(_error, errorCallback).one(_load, loadCallback), _triggerCallback(customLoader, element, function(response) {
                    response ? (element.off(_load), loadCallback()) : (element.off(_error), errorCallback());
                }) || element.trigger(_error);
            } else {
                var imageObj = $(new Image());
                imageObj.one(_error, errorCallback).one(_load, function() {
                    element.hide(), tag == _img ? element.attr(_sizes, imageObj.attr(_sizes)).attr(_srcset, imageObj.attr(_srcset)).attr(_src, imageObj.attr(_src)) : element.css(_backgroundImage, "url('" + imageObj.attr(_src) + "')"), 
                    element[config.effect](config.effectTime), removeAttribute && (element.removeAttr(srcAttribute + " " + srcsetAttribute + " " + retinaAttribute + " " + config.imageBaseAttribute), 
                    sizesAttribute !== _sizes && element.removeAttr(sizesAttribute)), element.data(loadedName, !0), 
                    _triggerCallback(_afterLoad, element), imageObj.remove(), _reduceAwaiting();
                });
        ...
        function _getCorrectedSrcSet(srcset, imageBase) {
            if (imageBase) {
                ...
                srcset = "";
                for (var i = 0, l = entries.length; i < l; i++) srcset += imageBase + entries[i].trim() + (i !== l - 1 ? "," : "");
            }
            return srcset;
        }
        ...
        function _triggerCallback(callback, element, args) {
            return !!(callback = config[callback]) && (callback.apply(instance, [].slice.call(arguments, 1)), 
            !0);
        }
    ...
    function LazyPlugin(elements, settings) {
        ...
        return _instance.config = function(entryName, value) {
            ...
            return $(_config.appendScroll).off("." + _namespace, _events.e), $(window).off("." + _namespace), 
            _events = {}, undefined;
    ...
    $.fn.Lazy = $.fn.lazy = function(settings) {
        ...
        if ($.isFunction(elements) && (loader = elements, elements = []), $.isFunction(loader)) {
            ...
            for (var config = LazyPlugin.prototype.config, forced = config._f || (config._f = {}), i = 0, l = names.length; i < l; i++) (config[names[i]] === undefined || $.isFunction(config[names[i]])) && (config[names[i]] = loader);
    ...
    "use strict";
    "function" == typeof define && define.amd ? define([], factory) : "object" == typeof exports ? module.exports = factory() : root.Headroom = factory();
}(this, function() {
    "use strict";
    ...
    function Headroom(elem, options) {
        options = extend(options, Headroom.options), this.lastKnownScrollY = 0, this.elem = elem, 
        this.tolerance = normalizeTolerance(options.tolerance), this.classes = options.classes, 
        this.offset = options.offset, this.scroller = options.scroller, this.initialised = !1, 
        this.onPin = options.onPin, this.onUnpin = options.onUnpin, this.onTop = options.onTop, 
        this.onNotTop = options.onNotTop, this.onBottom = options.onBottom, this.onNotBottom = options.onNotBottom;
    }
    var features = {
        bind: !!function() {}.bind,
    ...
    Debouncer.prototype = {
        ...
        destroy: function() {
            ...
            this.initialised = !1, this.elem.classList.remove(classes.unpinned, classes.pinned, classes.top, classes.notTop, classes.initial), 
        ...
        pin: function() {
            var classList = this.elem.classList, classes = this.classes;
            classList.contains(classes.unpinned) && (classList.remove(classes.unpinned), classList.add(classes.pinned), 
        ...
        notTop: function() {
            var classList = this.elem.classList, classes = this.classes;
            classList.contains(classes.notTop) || (classList.add(classes.notTop), classList.remove(classes.top), 
            this.onNotTop && this.onNotTop.call(this));
        },
        bottom: function() {
            var classList = this.elem.classList, classes = this.classes;
            classList.contains(classes.bottom) || (classList.add(classes.bottom), classList.remove(classes.notBottom), 
            this.onBottom && this.onBottom.call(this));
        },
        notBottom: function() {
            var classList = this.elem.classList, classes = this.classes;
            classList.contains(classes.notBottom) || (classList.add(classes.notBottom), classList.remove(classes.bottom), 
        ...
        isOutOfBounds: function(currentScrollY) {
            var pastTop = currentScrollY < 0, pastBottom = currentScrollY + this.getScrollerPhysicalHeight() > this.getScrollerHeight();
        ...
        update: function() {
            ...
            this.shouldUnpin(currentScrollY, toleranceExceeded) ? this.unpin() : this.shouldPin(currentScrollY, toleranceExceeded) && this.pin(), 
    ...
    }, Headroom.cutsTheMustard = "undefined" != typeof features && features.rAF && features.bind && features.classList, 
    Headroom;
}), function($) {
    $ && ($.fn.headroom = function(option) {
        return this.each(function() {
            var $this = $(this), data = $this.data("headroom"), options = "object" == typeof option && option;
            options = $.extend(!0, {}, Headroom.options, options), data || (data = new Headroom(this, options), 
            data.init(), $this.data("headroom", data)), "string" == typeof option && (data[option](), 
    ...
    Hypher.TrieNode, Hypher.prototype.createTrie = function(patternObject) {
        ...
        for (i = 0; i < wordLength; i += 1) for (node = trie, j = i; j < wordLength && (node = node[characterPoints[j]], 
        node); j += 1) if (nodePoints = node._points) for (k = 0, nodePointsLength = nodePoints.length; k < nodePointsLength; k += 1) points[i + k] = m(points[i + k], nodePoints[k]);
